...
async def create_route(
    ...
    """Create a new route"""
    route = await service.create_route(route_data, UUID(current_user.userId))

    return SuccessResponse(data=route, message="Route created successfully")
...
async def get_routes(
    ...
    routes, total, total_pages = await service.get_all_routes(page, perPage, isActive)
...
async def update_route(
    ...
    return SuccessResponse(data=route, message="Route updated successfully")
...
async def delete_route(
    ...
    return SuccessResponse(data=result, message="Route deleted successfully")
