...
const Code = styled.span`font-family: ${({ theme }) => theme.typography.fontFamily.mono}; font-size: 13px; color: ${({ theme }) => theme.colors.primary[500]};`;
...
const Tag = styled.span`padding: 2px 8px; background: ${({ theme }) => theme.colors.primary[50]}; color: ${({ theme }) => theme.colors.primary[700]}; border-radius: 4px; font-size: 11px;`;
