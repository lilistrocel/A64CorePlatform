...
async def create_shipment(
    ...
    shipment = await service.create_shipment(shipment_data, UUID(current_user.userId))

    return SuccessResponse(data=shipment, message="Shipment created successfully")
...
async def update_shipment(
    ...
    return SuccessResponse(data=shipment, message="Shipment updated successfully")
...
async def update_shipment_status(
    ...
    return SuccessResponse(
        data=shipment, message=f"Shipment status updated to {status.value}"
    )
...
async def delete_shipment(
    ...
    return SuccessResponse(data=result, message="Shipment deleted successfully")
...
async def assign_orders_to_shipment(
    ...
    result = await service.assign_orders_to_shipment(
        shipment_id, request.orderIds, UUID(current_user.userId)
    )
...
async def get_shipment_orders(
    ...
    return SuccessResponse(
        data=orders, message=f"Retrieved {len(orders)} orders from shipment"
    )
