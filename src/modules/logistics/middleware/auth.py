"""
Logistics Module - Authentication Middleware
...
from src.modules.logistics.config.settings import settings
...
def require_permission(permission: str):
    ...
    Args:
        permission: Required permission (e.g., "logistics.view", "logistics.create")
    ...
    async def permission_checker(
        ...
        if permission in ["logistics.create", "logistics.edit", "logistics.delete"]:
