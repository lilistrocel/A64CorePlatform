...
api_router.include_router(
    campaigns_router, prefix="/campaigns", tags=["marketing-campaigns"]
)
api_router.include_router(
    channels_router, prefix="/channels", tags=["marketing-channels"]
)
api_router.include_router(events_router, prefix="/events", tags=["marketing-events"])
api_router.include_router(
    dashboard_router, prefix="/dashboard", tags=["marketing-dashboard"]
)
