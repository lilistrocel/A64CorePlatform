...
class PlantDataService:
    ...
    CSV_COLUMNS = [
        ...
        "sunlightHoursDaily",
        "fertilizationScheduleDays",
        "pesticideScheduleDays",
    ...
    def _parse_csv_row_to_create(row: dict) -> PlantDataCreate:
        ...
        return PlantDataCreate(
            ...
            fertilizationScheduleDays=int(row["fertilizationScheduleDays"]) if row.get("fertilizationScheduleDays") else None,
            pesticideScheduleDays=int(row["pesticideScheduleDays"]) if row.get("pesticideScheduleDays") else None,
