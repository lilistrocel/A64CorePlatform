...
const StatusBadge = styled.span<{ $status: string }>`
  ...
  ${({ $status }) => {
    switch ($status) {
      ...
      case 'confirmed':
        return 'background: rgba(15,110,86,0.08); color: #0F6E56;';
      case 'processing':
        return 'background: rgba(184,132,42,0.10); color: #B8842A;';
      case 'shipped':
        return 'background: rgba(15,110,86,0.08); color: #0F6E56;';
      case 'delivered':
        return 'background: rgba(15,110,86,0.10); color: #0B5644;';
      case 'cancelled':
