/**
 * AddPlantDataModal Component
 *
 * Modal dialog for creating new plant data entries.
...
export interface AddPlantDataModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;
}
      ...
      <Modal>
        ...
        <ModalBody>
            ...
            <Section>
              ...
              <FormGroup>
                <Label>Farm Type Compatibility * (Select all that apply)</Label>
                <Controller
                    ...
                    <CheckboxGrid>
                      {[
                        ...
                        <CheckboxLabel key={ft.value}>
                          <Checkbox
                            type="checkbox"
                            checked={field.value.includes(ft.value)}
              ...
              <FormGroup>
                ...
                <Input
                  ...
                  {...register('tags')}
                />
                <HelpText>Separate multiple tags with commas</HelpText>
              </FormGroup>
            </Section>
            ...
            <Section>
              ...
              <GridRow $columns={3}>
                <FormGroup>
                  ...
                  <Input
                    ...
                    disabled={submitting}
                    {...register('germinationDays', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                  />
                </FormGroup>
              ...
              <FormGroup>
                ...
                <HelpText>Total days from seed to harvest</HelpText>
              </FormGroup>
            </Section>
                  ...
                  <GridRow $columns={3}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="e.g., 15"
                        disabled={submitting}
                        {...register('temperatureMin', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="e.g., 25"
                        disabled={submitting}
                        {...register('temperatureOptimal', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="e.g., 35"
                        disabled={submitting}
                        {...register('temperatureMax', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                  </GridRow>
                  ...
                  <GridRow $columns={3}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="0-100"
                        disabled={submitting}
                        {...register('humidityMin', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="0-100"
                        disabled={submitting}
                        {...register('humidityOptimal', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="0-100"
                        disabled={submitting}
                        {...register('humidityMax', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                  </GridRow>
                </Section>
                  ...
                  <GridRow $columns={3}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="e.g., 3"
                        disabled={submitting}
                        {...register('wateringFrequencyDays', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="e.g., 1.5"
                        disabled={submitting}
                        {...register('waterAmountPerPlant', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                  ...
                  <GridRow $columns={3}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        disabled={submitting}
                        {...register('phMin', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        disabled={submitting}
                        {...register('phOptimal', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        disabled={submitting}
                        {...register('phMax', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                  </GridRow>
                </Section>
                  ...
                  <GridRow $columns={3}>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="0-24"
                        disabled={submitting}
                        {...register('dailyLightHoursMin', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="0-24"
                        disabled={submitting}
                        {...register('dailyLightHoursOptimal', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="0-24"
                        disabled={submitting}
                        {...register('dailyLightHoursMax', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                  </GridRow>
                </Section>
                  ...
                  <GridRow>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        disabled={submitting}
                        {...register('averageMarketValuePerKg', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                  ...
                  <GridRow>
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="e.g., 30"
                        disabled={submitting}
                        {...register('spacingBetweenPlantsCm', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        placeholder="e.g., 60"
                        disabled={submitting}
                        {...register('spacingBetweenRowsCm', { setValueAs: v => v === '' || isNaN(v) ? undefined : Number(v) })}
                      />
                    </FormGroup>
                  </GridRow>
