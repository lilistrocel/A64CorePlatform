...
from src.modules.hr.config.settings import settings
...
def require_permission(permission: str):
    ...
    Args:
        permission: Required permission (e.g., "hr.view", "hr.create")
