...
const StatusBadge = styled.span<{ $status: PRStatus }>`
  ...
  background: ${({ $status, theme }) => {
    switch ($status) {
      ...
      case 'Approved': return theme.colors.successBg || '#ecfdf5';
      case 'Rejected': return theme.colors.errorBg || '#fef2f2';
  ...
  color: ${({ $status, theme }) => {
    switch ($status) {
      ...
      case 'Approved': return theme.colors.success || '#10b981';
      case 'Rejected': return theme.colors.error || '#ef4444';
