"""
Sales Module - Authentication Middleware
...
def require_permission(permission: str):
    ...
    Args:
        permission: Required permission (e.g., "sales.view", "sales.manage")
