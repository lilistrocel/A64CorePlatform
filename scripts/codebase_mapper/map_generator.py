...
def gen_index(db) -> str:
    ...
    lines = [
        ...
        f"- **Infrastructure:** Docker Compose, Nginx, 10 business modules (see Module Directory)",
    ...
    lines += [
        ...
        f"| `purchasing` | `src/modules/purchasing/` | PR→PO→GR→AP chain, vendors, approvals |",
        f"| `finance` | `src/modules/finance/` | Journal entries, CoA, periods (MySQL microservice, profile-gated) |",
