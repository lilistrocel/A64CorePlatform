...
async def create_employee(
    ...
    employee = await service.create_employee(employee_data, UUID(current_user.userId))
...
async def get_employees(
    ...
    status: Optional[EmployeeStatus] = Query(
        None, description="Filter by employee status"
    ),
    department: Optional[str] = Query(None, description="Filter by department"),
    search: Optional[str] = Query(
        None, max_length=500, description="Search by name, email, or department"
    ),
...
async def delete_employee(
    ...
    return SuccessResponse(data=result, message="Employee deleted successfully")
...
async def create_visa_for_employee(
    ...
    return SuccessResponse(data=visa, message="Visa created successfully")
...
async def create_insurance_for_employee(
    ...
    return SuccessResponse(data=insurance, message="Insurance created successfully")
...
async def create_performance_review_for_employee(
    ...
    return SuccessResponse(
        data=review, message="Performance review created successfully"
    )
